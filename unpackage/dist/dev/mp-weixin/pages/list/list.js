...
const bookItem = () => "../bookItem/bookItem2.js";
const _sfc_main = {
  // props:{
  // 	title:{
  // 		type:String,
...
if (!Array) {
  const _component_book_item = common_vendor.resolveComponent("book-item");
  _component_book_item();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.f($data.books, (book, k0, i0) => {
      return {
        a: "4eb6f3d4-0-" + i0,
        b: common_vendor.p({
          book
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/mima123/Documents/HBuilderProjects/test/pages/list/list.vue"]]);
